...
export default function FilthOMeter() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-32 right-4 lg:right-12 rotate-6 hidden md:block pointer-events-none">
            ...
            <div className="hidden lg:block pt-4">
              <div className="bg-white border-2 border-slate-900 rounded-2xl p-4 shadow-[5px_5px_0_0_#FFD60A] -rotate-1">
                ...
                <p className="text-sm text-slate-800 italic leading-snug">
                  "Quoted $480 over WhatsApp, paid $480 on the day. Exactly what they said."
                </p>
                <div className="text-[9px] tracking-[0.2em] uppercase font-bold text-slate-500 mt-2">— Sarah, Brighton</div>
              </div>
            </div>
          </div>
            ...
            >
              <div className="bg-white rounded-3xl border-2 border-slate-900 shadow-[10px_10px_0_0_#0F172A] overflow-hidden">
                ...
                <div className="p-4 lg:p-6 space-y-4">
                    ...
                    <div className="relative mb-3">
                      ...
                      >
                        <div
                          ...
                          style={{
                            backgroundImage: 'radial-gradient(circle at 15% 50%, #000 1px, transparent 2px), radial-gradient(circle at 35% 30%, #000 1.5px, transparent 2.5px), radial-gradient(circle at 55% 70%, #000 1px, transparent 2px)',
                          ...
                          {[...Array(6)].map((_, i) => (
                            <div
                              ...
                              style={{
                                ...
                                width: `${3 + (i % 3) * 2}px`,
                                height: `${3 + (i % 3) * 2}px`,
                                animation: `bubble-up 3s ease-in-out ${i * 0.3}s infinite`,
                              }}
                            />
                          ))}
                        </div>
                  ...
                  <Link
                    href="/contact"
                    className="group flex items-center justify-between gap-3 px-5 py-4 bg-yellow-400 text-slate-900 font-bold rounded-2xl border-2 border-slate-900 shadow-[4px_4px_0_0_#00B8D9] hover:shadow-[0_0_0_0_#00B8D9] hover:translate-x-1 hover:translate-y-1 transition-all text-base"
                  >
                    <span className="flex items-center gap-2">
                      <Zap className="w-4 h-4" strokeWidth={2.5} />
                      Lock this exact quote
                    </span>
