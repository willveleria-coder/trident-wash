...
export default function ServicesPageContent() {
  return (
    <main>
          ...
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            >
              ...
              <div className="relative rounded-3xl overflow-hidden border-2 border-slate-900 shadow-[8px_8px_0_0_#00B8D9] aspect-[4/3]">
                <img
                  src="/service.png"
                  alt="Trident technician pressure washing a concrete driveway in Melbourne"
            ...
            >
              ...
              <p className="text-slate-600 text-base lg:text-lg leading-relaxed font-medium mb-8 border-l-4 border-[#00B8D9] pl-5">
                Not every surface can handle the same pressure. Blasting a render wall like a concrete driveway will crack and pit it within months. We match PSI, nozzle angle, dwell time, and cleaning agents to what&rsquo;s actually in front of us — so you get a spotless result without hidden damage that shows up later.
              </p>
      ...
      {/* ── FULL SERVICE INDEX (SEO) ─────────────────────────── */}
      <section className="relative py-20 lg:py-28 bg-white overflow-hidden">
        <div className="absolute top-0 -left-32 w-[500px] h-[500px] rounded-full bg-yellow-300/15 blur-[90px] pointer-events-none" />
        ...
        <div className="relative max-w-[1440px] mx-auto px-6 lg:px-10">
          ...
          >
            ...
            <h2 className="font-display text-4xl lg:text-5xl leading-[0.9] tracking-tightest text-slate-900 max-w-3xl">
              Pick a surface,
              <span
            ...
            <p className="mt-5 text-slate-600 text-lg leading-relaxed font-medium max-w-xl border-l-4 border-[#00B8D9] pl-5">
              Each page covers what&rsquo;s included, what it costs, and the questions we get asked most.
            </p>
          </motion.div>
            ...
            {SERVICES.map((s, i) => (
              ...
              >
                <Link
                  ...
                  className="group flex h-full flex-col rounded-3xl border-2 border-slate-900 bg-white p-7 shadow-[6px_6px_0_0_#0F172A] transition-all hover:translate-x-1 hover:translate-y-1 hover:shadow-[0_0_0_0_#0F172A]"
                >
                  <h3 className="font-display text-2xl leading-none tracking-tightest text-slate-900">
                    {s.name}
                  </h3>
                  <p className="mt-3 flex-1 text-sm leading-relaxed text-slate-600 font-medium">
                    {s.blurb}
                  </p>
                  <span className="mt-5 inline-flex items-center gap-2 text-sm font-bold text-[#00B8D9]">
